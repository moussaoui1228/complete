        ...
        html: `
            <div style="font-family: sans-serif; max-width: 600px; margin: auto; padding: 30px; border: 1px solid #eee; border-radius: 10px;">
                ...
                <div style="margin-top: 30px; text-align: center;">
                    <a href="${process.env.FRONTEND_URL || 'http://localhost:5173'}/suivi" style="color: #4a6741; font-weight: bold; text-decoration: underline;">Voir les détails on mon compte</a>
                </div>
            </div>
        `,
    };
