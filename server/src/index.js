...
const cors = require('cors'); // Handles Cross-Origin Resource Sharing (security for web requests)
const dotenv = require('dotenv'); // Loads secret variables from the .env file
const path = require('path');
const rateLimit = require('express-rate-limit'); // Prevents spamming the API
const helmet = require('helmet'); // Adds security headers to prevent basic attacks
const mongoSanitize = require('express-mongo-sanitize'); // Prevents database injection attacks
const xss = require('xss-clean'); // Prevents malicious scripts from being injected
const hpp = require('hpp'); // Prevents parameter pollution in URLs

// Import all our route definitions
const authRoutes = require('./routes/auth');
const orderRoutes = require('./routes/orders').default;
const pressingRoutes = require('./routes/pressing').default;
const settingsRoutes = require('./routes/settings').default;
const shippingRatesRoutes = require('./routes/shippingRates').default;
...
const pricesRoutes = require('./routes/prices').default;
